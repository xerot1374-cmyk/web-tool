    ...
    slots: [
      {
        ...
        shape: "blob",
        clipPath:
          "polygon(12% 6%, 88% 4%, 98% 28%, 92% 88%, 14% 96%, 2% 64%, 6% 22%)",
      },
      {
        id: "slot-2",
        x: 0.41,
        ...
        shape: "organic",
        clipPath:
          "polygon(10% 2%, 88% 8%, 100% 26%, 94% 84%, 74% 100%, 18% 94%, 0% 66%, 2% 16%)",
      },
      {
        id: "slot-3",
        x: 0.27,
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "slot-2", x: 0.52, y: 0.16, w: 0.28, h: 0.5, radius: 28 },
      {
        ...
        shape: "arch",
        clipPath:
          "polygon(0% 100%, 0% 24%, 20% 6%, 50% 0%, 80% 6%, 100% 24%, 100% 100%)",
      },
      {
        id: "slot-4",
        x: 0.31,
...
export function getFirstAvailableFrameSlotId(
  ...
  return (
    slots.find((slot) => !usedSlotIds.includes(slot.id))?.id ?? slots[0]?.id
  );
}
