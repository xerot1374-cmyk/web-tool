      ...
      <div className="portal-wrapper">
        ...
        <div className="portal-hero">
          <div>
            ...
            <h1 className="main-heading portal-heading">
              Manage your content workspace
            </h1>
            <p className="description portal-description">
              Open your profile, review activity and insights, or jump straight
              into the template editor from one place.
            </p>
          </div>

          <div className="portal-hero-panel">
            <div className="portal-hero-label">Quick Access</div>
            <div className="portal-hero-value">
              {user.isAdmin ? "4 core areas" : "3 core areas"}
            </div>
        ...
        <section className="portal-grid">
          ...
          <Link href="/account/analytics" className="portal-card">
            ...
            <p className="portal-card-text">
              Review all activities for LinkedIn posts and Instagram posts or
              stories, then open the insight panels.
            </p>
          ...
          <Link href="/account/linkedin/template-a" className="portal-card">
            ...
            <p className="portal-card-text">
              Launch the main LinkedIn template editor directly and continue
              working without extra route hops.
            </p>
          ...
          {user.isAdmin && (
            <Link href="/account/users" className="portal-card">
              ...
              <p className="portal-card-text">
                Block, unblock, or permanently delete user accounts from one
                admin area.
              </p>
