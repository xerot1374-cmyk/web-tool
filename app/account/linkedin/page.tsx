    ...
    <main className="app-container">
      <div className="content-wrapper">
        ...
        <div className="template-grid">
          {/* TEMPLATE A */}
          <Link href="/account/linkedin/template-a" className="template-card">
            <div>
          ...
          {/* TEMPLATE B */}
          <Link href="/account/linkedin/template-b" className="template-card">
            <div>
              <div className="template-title">
          ...
          <Link href="/account/linkedin/product-intro" className="template-card">
            <div>
